    ...
    <div class="container">
        <form action="{{route("produto.update", $produto->id)}}" method="POST">
            ...
            <div class="form-group">
              ...
              <input name="nome" type="text" class="form-control" id="id-input-nome" placeholder="Nome" value="{{$produto->nome}}">
            </div>
            <div class="form-group">
                <label for="id-input-preco">Preço</label>
                <input name="preco" type="text" class="form-control" id="id-input-preco" placeholder="Preço" value="{{$produto->preco}}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input name="ingredientes" type="text" class="form-control" id="id-input-ingrediente" placeholder="Ingredientes" value="{{$produto->ingredientes}}">
            </div>
            <div class="form-group">
                <label for="id-input-imagem">URL Imagem</label>
                <input name="urlImage" type="text" class="form-control" id="id-input-imagem" placeholder="URL Imagem" value="{{$produto->urlImage}}">
            </div>
            <div class="my-2">
